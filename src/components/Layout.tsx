...
import Kaiser from "../lib/images/kaiserfit_logo.webp";
  ...
  return (
    <>
      <header className="bg-gray-600 dark:bg-slate-600 w-full p-4 flex justify-between items-center">
        <div className="relative w-1/2 md:w-1/3 lg:w-1/5 h-12">
          <img src={Kaiser} alt="" className="absolute w-full h-full" />
        </div>
